...
class ProductConfigSession(models.Model):
    ...
    def create_get_bom(self, variant, product_tmpl_id=None, values=None):
        ...
        attr_products = variant.product_template_attribute_value_ids.mapped('product_attribute_value_id.product_id')
        ...
        updates = mrpBom.onchange(bom_values, ["product_id", "product_tmpl_id", "bom_line_ids"], specs)
        values = updates.get("value", {})
