$(document).ready(function () {
    ...
    $('button.cfg_clear').on('click', function(event){
        var path = window.location.pathname;
        openerp.jsonRpc(path + "/config_clear", 'call', {}).then(
            function (res) {
                if (res) {
    ...
    function update_config_image(cfg_vals) {
        openerp.jsonRpc(path + "/image_update", 'call', {'cfg_vals': cfg_vals}).then(
            function (res) {
                if (res) {
    ...
    function value_onchange(cfg_vals) {
        ...
        openerp.jsonRpc(path + "/value_onchange", 'call', {'cfg_vals': cfg_vals}).then(
                function (res) {
                    if (res) {
